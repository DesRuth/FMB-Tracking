                        ...
                        if(task.isSuccessful()){
                            ...
                            fuser.sendEmailVerification().addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    Toast.makeText(DriverRegisterActivity.this, "Verification Email Has been Sent.", Toast.LENGTH_SHORT).show();
                                }
                            ...
                            Toast.makeText(DriverRegisterActivity.this, "Registered Successfully", Toast.LENGTH_SHORT).show();
                            ...
                            newUserRef.set(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        Toast.makeText(DriverRegisterActivity.this, "user created", Toast.LENGTH_SHORT).show();
                                        redirectLoginScreen();
                                    }
                                }
                            });
                            ...
                            Toast.makeText(DriverRegisterActivity.this, "Error ! " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
